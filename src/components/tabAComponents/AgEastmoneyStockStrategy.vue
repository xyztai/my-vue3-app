    ...
    >
      ...
      <el-table-column prop="ratioB" :label="'说明'" align="left" min-width="1000" sortable width="auto" >
        <template #default="scope">
          ...
          <!-- 负值 -->
          <span style="background-color: rgb(0, 100, 0); color: rgb(255, 255, 255); font-size: 20px; font-weight: bold; align: right; width: 200px;">
...
export default {
  ...
  methods: {
    ...
    getStartString(str) {
      ...
      return str.replace(reg, `${targetWord}${targetWord}`);

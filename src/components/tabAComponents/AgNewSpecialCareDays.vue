<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="stockCode" label="名称" align="left" width="120" sortable fixed />
      <el-table-column prop="last" label="cp" align="center" min-width="70" width="auto" :formatter="formatAmount" />
      <el-table-column prop="ratioB" label="买(止损5%)" align="center" min-width="70" width="auto" :formatter="formatAmount" />
